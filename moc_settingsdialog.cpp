...
QT_MOC_LITERAL(1, 15, 13), // "signalClosing"
...
QT_MOC_LITERAL(6, 53, 25) // "checkCustomBaudRatePolicy"
    ...
    "SettingsDialog\0signalClosing\0\0"
    "showPortInfo\0idx\0apply\0checkCustomBaudRatePolicy"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsDialog::signalClosing)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SettingsDialog::signalClosing()
{
